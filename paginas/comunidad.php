...
?>
    <script>
        window.COMMUNITY_FILE_URL = './community-file.php';
    </script>
        ...
        <main id="home">
            ...
            <section class="section-B" id="search-section">
                <div class="section-buttons">
                    <h2 class="section-title">Selecciona un juego para ver su comunidad</h2>
                </div>
                    ...
                    <div class="row g-3 mt-2">
                        <div class="col-12">
                            <div style="display: flex; align-items: center; gap: 12px;">
                                ...
                                <select class="form-control select-dark" id="games-sort-select">
            ...
            <section class="search-grid">
                ...
                <div class="search-grid-filters">
                                ...
                                <!-- Category Filters -->
                                <div style="padding: 5px 10px;">
                                    <?php renderFilterGroup('Categorías', ['Acción', 'Aventura', 'Puzzle', 'RPG', 'Estrategia', 'Casual', 'Indie'], 'categories'); ?>
                                </div>
                                ...
                                <!-- Platform Filters -->
                                <div style="padding: 5px 10px;">
                                    <?php renderFilterGroup('Plataforma', ['Windows', 'Linux', 'macOS', 'Switch', 'PlayStation', 'Xbox'], 'platforms'); ?>
                                </div>
                                ...
                                <div style="padding: 5px 10px;">
                                    <?php renderFilterGroup('Estado de lanzamiento', ['Early Access', 'Lanzado', 'Próximo lanzamiento'], 'releaseStatus'); ?>
                                </div>
                            </div>
            </section>
        </main>
