                            ...
                            <div style="padding: 5px 10px;">
                                ...
                                <div style="display: flex; flex-direction: column; gap: 10px;">
                                    <div style="position: relative; height: 30px; display: flex; align-items: center;">
                                        <input type="range" id="dateMax" min="0" max="100" value="100" style="width: 100%; position: absolute; height: 6px; accent-color: var(--base-sky-main); -webkit-appearance: none;">
                                        <input type="range" id="dateMin" min="0" max="100" value="0" style="width: 100%; position: absolute; height: 6px; accent-color: var(--base-sky-main); -webkit-appearance: none; z-index: 10;">
                                    </div>
                                    <div style="display: flex; gap: 2.5px; align-items: center; justify-content: center;">
                                        <div style="background-color: white; border-radius: 6px; padding: 5px; text-align: center; font-size: 12px; color: var(--base-gray-400); flex: 1;"><span id="minDate">0</span></div>
                                        <span style="width: 4px; height: 4px; background-color: white; border-radius: 1px;"></span>
                                        <div style="background-color: white; border-radius: 6px; padding: 5px; text-align: center; font-size: 12px; color: var(--base-gray-400); flex: 1;"><span id="maxDate">100</span></div>
                                    </div>
                                </div>
                            </div>
